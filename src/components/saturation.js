...
export default class Saturation extends Controller {
  ...
  constructor(object, property, params) {
    ...
    function onMouseDrag(e) {
      ...
      self.setValue(1 - (Y / bgRect.height), 'color.color.v', true); // Reverse the Y value
  ...
  updateDisplay() {
    ...
    const Ypos = parseInt((1 - this.object.color.color.v) * 100); // Reverse the Y value again for proper shape calc
